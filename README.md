...
### 🟡 第五類別：AI 智慧備課工具系列 (剛好備課所)

#### 7. 剛好備課所 (LessonPrep)
- **核心定位**：國數自社學科 AI 備課、教案助手與教材輸出整合工作桌，把備課靈感一站轉化為精彩課堂。
- **主要功能**：
  - **四大領域 AI 備課**：國語（課文分析/修辭/素養提問）、數學（概念梳理/題目生成）、自然（科學探究/實驗變因設計）、社會（課文重點/素材延伸）。
  - **萬用助手與教材生成**：免費 AI 教師助手、作文寫作引導學習單產生器、數學試題幾何與數線繪圖 V2。
  - **排版與格式輸出**：支援 Markdown 一鍵轉 PPTX 簡報與專業 Word (DOCX) 文件。
- **工具連結**：[剛好備課所 (LessonPrep)](https://kentxchang-goedutw.github.io/lessonprep/)
